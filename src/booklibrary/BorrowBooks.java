...
public class BorrowBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(197, 253, 92));

        jLabel1.setBackground(new java.awt.Color(182, 26, 253));
        jLabel1.setFont(new java.awt.Font("Ubuntu", 0, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(144, 83, 253));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       this.title=jTextField1.getText();
        this.friendname=jTextField2.getText();
        this.cost=Integer.parseInt(jTextField4.getText());
        this.year=Integer.parseInt(jTextField3.getText());
        this.pbr= jTextField5.getText();
        mdata.borrowbook(title,friendname,year,cost,pbr);
        this.dispose();
